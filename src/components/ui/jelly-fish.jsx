...
const PHRASES = ["DESIGN", "IMPACT", "FUTURE", "GROWTH", "VISION"];
const LOOP = 20; 
...
const MANIFESTO =
  "ENGINEERED FOR EXCELLENCE. DESIGNED TO SCALE YOUR BRAND. WE CRAFT DIGITAL EXPERIENCES.";

const TICK_LABELS = ["CODE", "CGI", "FILM", "AI"];
...
export function Jellyfish3D({ loop = 20 }) {
  return (
    <Canvas
      flat
...
export default function JellyfishDrift() {
  return (
    ...
    >
      ...
      >
        {[
          "WHERE STRATEGY MEETS CREATIVITY — BUILT TO ELEVATE BRANDS",
