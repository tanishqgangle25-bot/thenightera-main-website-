...
/* ── animation variants (ported from the original component) ── */
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white px-4">
      <SEOHead
        ...
        description="This page doesn't exist. Go back to thenightera — the best marketing agency in Indore."
        path="/404"
        noIndex={true}
      />
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-4 md:gap-6 mb-8 md:mb-12">
            <motion.span
              className="text-[80px] md:text-[120px] font-bold text-[#222222] opacity-70 font-signika select-none leading-none"
          ...
          >
            <Link
              to="/"
              className="inline-block bg-[#222222] text-white px-8 py-3 rounded-full text-lg font-medium hover:bg-black transition-colors font-dm-sans select-none"
            >
              Find shelter
            </Link>
          </motion.div>
          ...
          <motion.div className="mt-8" variants={itemVariants}>
            <Link
              to="/contact"
              className="text-[#222222] opacity-50 hover:opacity-70 transition-opacity underline font-dm-sans select-none text-sm"
            >
              Talk to us instead →
            </Link>
          </motion.div>
